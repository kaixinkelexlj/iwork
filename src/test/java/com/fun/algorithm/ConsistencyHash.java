...
public class ConsistencyHash {
    ...
    public void init() {
        ...
        shards.add("192.168.0.0-server0");
        shards.add("192.168.0.1-server1");
        shards.add("192.168.0.2-server2");
        shards.add("192.168.0.3-server3");
        shards.add("192.168.0.4-server4");
