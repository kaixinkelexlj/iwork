...
/**
 * 类SimHash.java的实现描述：SimHash.java
 * @author lujun.xlj Jan 10, 2017 6:15:09 PM
 */
public class SimHash {
    ...
    private BigInteger hash(String source) {
        ...
        return new BigInteger(String.valueOf(source.hashCode()));
    }
    ...
    public static void main(String[] args) {
        ...
        SimHash sh1 = new SimHash(ss1);
        SimHash sh2 = new SimHash(ss2);
        SimHash sh3 = new SimHash(ss3);

        System.out.println(getDistance(sh1.strSimHash, sh2.strSimHash) + "," + sh1.hammingDistance(sh2));
        System.out.println(getDistance(sh1.strSimHash, sh3.strSimHash) + "," + sh1.hammingDistance(sh3));
        System.out.println(getDistance(sh2.strSimHash, sh3.strSimHash) + "," + sh2.hammingDistance(sh3));
