...
/**
 * @author lujun.xlj
 * @version $Id: LuceneUtils.java, v 0.1 Jun 28, 2016 3:38:12 PM lujun.xlj Exp $
 */
public class LuceneUtils {
    ...
    public static FSDirectory openFSDirectory(String luceneDir) {
        ...
        try {
            ...
            /**
             * 注意：isLocked方法内部会试图去获取Lock,如果获取到Lock，会关闭它，否则return false表示索引目录没有被锁， 这也就是为什么unlock方法被从IndexWriter类中移除的原因
             */
    ...
    public static Highlighter createHighlighter(Query query, String prefix, String stuffix, int fragmenterLength) {
        org.apache.lucene.search.highlight.Formatter formatter = new SimpleHTMLFormatter((prefix == null || prefix.trim().length() == 0) ? "<font color=\"red\">" : prefix,
