...
public class AopFun {
  ...
  @Pointcut("@within(com.work.aop.FunService) && !@annotation(com.work.aop.IgnoreFun)")
  public void funService() {

  }

  @Around("funService()")
  public void funServiceInterceptor(ProceedingJoinPoint pjp) throws Throwable {
    System.out.println("before funServiceInterceptor");
    pjp.proceed();
    System.out.println("after funServiceInterceptor");
  }
